                ...
                <div class="label">
                    <div class="info">
                        ...
                        <input type="text" name="search[title]"
                            value="<?php echo isset($_GET['search']['title']) ? $_GET['search']['title'] : ''; ?>">
                    </div>
                </div>
                <div class="label">
                    <div class="info">
                        ...
                        <input type="text" name="search[author]"
                            value="<?php echo isset($_GET['search']['author']) ? $_GET['search']['author'] : ''; ?>">
                    </div>
                </div>
                <div class="label">
                    <div class="info">
                        <label>Место издания:</label>
                        <input type="text" name="search[place]"
                            value="<?php echo isset($_GET['search']['place']) ? $_GET['search']['place'] : ''; ?>">
                    </div>
                </div>
                <div class="label">
                    <div class="info">
                        ...
                        <input type="text" name="search[year]"
                            value="<?php echo isset($_GET['search']['year']) ? $_GET['search']['year'] : ''; ?>">
                    </div>
                </div>
                <div class="info">
    ...
    foreach ($res as $row) {
        ...
        <tr>
            ...
            <td style="position: relative; width: 300px; text-align: center;">
                ...
                <hr
                    style="position: absolute; width: 95%; top: 42%; transform: translateY(-50%); border: none; border-top: 1px solid black;">
            ...
            <td style="position: relative; white-space: nowrap; max-width: 100px;">
                <div
                    style="overflow-x: scroll; width: 95%; position: absolute; top: 0;margin-top: 20px; transform: rotateX(180deg);">
                    <div style="transform: rotateX(180deg);">
                        <?php echo $row["inventnumber1"]; ?>
                    </div>
                </div>
                <hr
                    style="position: absolute; width: 90%; top: 42%; transform: translateY(-50%); border:none; border-top: 1px solid black;">
