...
<body>
    ...
    $sql = "SELECT `file`,`title`, `publicationtype`, `author`,`place`, `year`, `publisher`, `compedit`,`countpages`,`archive`,`BBK`,`inventnumber`,`numbinstances`,`lasttaker` FROM infprintedit " . $queryCondition;
